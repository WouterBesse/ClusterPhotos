...
function cyto_cytoscape(; kwargs...)
        available_props = Symbol[:id, :autoRefreshLayout, :autolock, :autoungrabify, :autounselectify, :boxSelectionEnabled, :className, :clearOnUnhover, :contextMenu, :contextMenuData, :dragNode, :elements, :extent, :generateImage, :imageData, :layout, :maxZoom, :minZoom, :mouseOutNode, :mouseOverNode, :mouseoverEdgeData, :mouseoverNodeData, :pan, :panningEnabled, :responsive, :selectedEdgeData, :selectedNodeData, :style, :stylesheet, :tapEdge, :tapEdgeData, :tapNode, :tapNodeData, :userPanningEnabled, :userZoomingEnabled, :wheelSensitivity, :zoom, :zoomingEnabled]
        wild_props = Symbol[]
