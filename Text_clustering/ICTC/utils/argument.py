...
# Add these lines to your argument parser in utils/argument.py
parser.add_argument('--filter', type=str, default="", help='Filter value to replace [FILTER] in prompt')
parser.add_argument('--filter-file', type=str, help='File containing filter value')
